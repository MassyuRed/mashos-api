...
# The omission decision is unchanged. A retained topic stays after its written
# referential premise; changed perspective and intervening context still retain it.
...
CASES = (
    ...
    # Ambiguous later も now declines the optional topic elision;
    # retain the source's author rather than guess the particle's role.
...
@pytest.mark.parametrize('text,retained', [
    ('私にとって家族と話す時間が大切です。その時間が取れるなら、僕は近況を伝えたい。', 'その時間が取れるなら、僕は、近況を伝えたい。'),
    ('私にとって家族と話す時間が大切です。昨日は友人と話した。その時間が取れるなら、私は近況を伝えたい。', 'その時間が取れるなら、私は、近況を伝えたい。'),
    ('家で落ち着けるなら、私にとって必要なのは、一人で過ごす時間です。その時間が取れるなら、私は本を読みたい。', 'その時間が取れるなら、私は、本を読みたい。'),
    ...
    ('私にとって家で過ごす時間が大切です。その時間が取れるなら、私は旅に出る前の鳥みたい。', 'その時間が取れるなら、私は、旅に出る前の鳥みたい。'),
    ...
    ('私が望んでいるのは、家で静かに過ごす時間です。その時間が取れるなら、私はゆっくり本を読みたい。', 'その時間が取れるなら、私は、ゆっくり本を読みたい。'),
