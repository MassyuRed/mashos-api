...
def test_rc0023_retains_chunk_and_typed_reception_contracts() -> None:
    ...
    assert surface.STEP11_CANDIDATE_VERSION_ID == "nls_v3_rc_0023"
...
def test_dense_units_are_committed_to_bounded_grammatical_chunks() -> None:
    ...
    assert plan.schema_version.endswith(".rc0023.v1")
