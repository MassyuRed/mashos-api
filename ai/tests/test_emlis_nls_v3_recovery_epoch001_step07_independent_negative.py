...
"""Dedicated Step 7 independent-negative proof source for Recovery Epoch 001."""

import importlib

import pytest

import emlis_ai_typed_surface_ast_v3 as step7_owner


_STEP = 7
_THIS_PATH = (
    "ai/tests/"
    "test_emlis_nls_v3_recovery_epoch001_step07_independent_negative.py"
)
_NODE_ID = f"{_THIS_PATH}::test_recovery_epoch001_step07_independent_negative"
_RED_CODE = "RECOVERY_EPOCH001_STEP07_DEDICATED_NEGATIVE_NOT_PROVED"
_EXPECTED_PROOF = {
...
def test_recovery_epoch001_step07_independent_negative() -> None:
    issues = step7_owner.validate_typed_surface_ast(
        {},
        discourse_plan={},
        inventory_result={},
        content_plan={},
