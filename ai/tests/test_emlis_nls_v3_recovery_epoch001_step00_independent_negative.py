...
"""Dedicated Step 0 independent-negative proof source for Recovery Epoch 001."""

import importlib

import pytest

from helpers import emlis_nls_v3_s0_s1_baseline as step0_owner
...
_NODE_ID = f"{_THIS_PATH}::test_recovery_epoch001_step00_independent_negative"
_RED_CODE = "RECOVERY_EPOCH001_STEP00_DEDICATED_NEGATIVE_NOT_PROVED"
_EXPECTED_PROOF = {
...
def test_recovery_epoch001_step00_independent_negative() -> None:
    issues = step0_owner.validate_step0({})
