# -*- coding: utf-8 -*-
"""Legacy astor myprofile report compat facade.

Runtime body now lives in ``astor_self_structure_report``. This file is intentionally
...
import astor_self_structure_report as _current
