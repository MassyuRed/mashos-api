...
def _build_ui_config(tier: SubscriptionTier, lang: str = "ja") -> Dict[str, Any]:
    ...
    if lang_norm == "en":
        strings: Dict[str, str] = {
            ...
            "paywall_text": "With your current plan, you cannot get another set. Upgrade to Plus Plan to generate questions anytime.",
        ...
        strings = {
            ...
            "paywall_text": "現在のプランでは「別の問いを受け取る」は利用できません。Plusプランになると、いつでも新しい問いを生成できます。",
