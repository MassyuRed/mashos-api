...
Env:
  ...
  - ASTOR_WORKER_JOB_TYPES=myprofile_latest_refresh_v1,snapshot_generate_v1,analyze_emotion_structure_standard_v1,generate_emotion_report_v2,inspect_emotion_report_v1   (comma separated)
