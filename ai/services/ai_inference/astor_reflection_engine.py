# -*- coding: utf-8 -*-
"""Legacy astor reflection engine compat facade.

Runtime body now lives in ``piece_generation_engine``. This file is intentionally
...
import piece_generation_engine as _current
