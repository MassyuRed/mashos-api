# -*- coding: utf-8 -*-
"""Legacy emotion reflection generation service compat facade.

Runtime body now lives in ``emotion_piece_generation_service``. This file is intentionally
...
import emotion_piece_generation_service as _current
