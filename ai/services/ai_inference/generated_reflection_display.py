# -*- coding: utf-8 -*-
"""Legacy generated reflection display compat facade.

Runtime body now lives in ``piece_generated_display``. This file is intentionally
...
import piece_generated_display as _current
