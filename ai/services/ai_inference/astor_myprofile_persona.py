# -*- coding: utf-8 -*-
"""Legacy astor myprofile persona compat facade.

Runtime body now lives in ``astor_self_structure_persona``. This file is intentionally
...
import astor_self_structure_persona as _current
