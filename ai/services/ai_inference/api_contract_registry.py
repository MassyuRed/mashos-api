...
PUBLIC_API_CONTRACTS: Tuple[ApiContractEntry, ...] = (
    ...
    ApiContractEntry('GET', '/emotion/reflection/quota', 'emotion.reflection.quota.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current-month publish quota / capability probe for Home reflection flow'),
    ApiContractEntry('POST', '/emotion/reflection/preview', 'emotion.reflection.preview.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Preview-only reflection generation; does not canonical-save Home input'),
    ApiContractEntry('POST', '/emotion/reflection/publish', 'emotion.reflection.publish.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Publishes a preview draft and reuses Home write fan-out / cache invalidation'),
    ApiContractEntry('POST', '/emotion/reflection/cancel', 'emotion.reflection.cancel.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Cancels a preview draft without mutating canonical Home input state'),
