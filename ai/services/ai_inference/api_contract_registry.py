...
PUBLIC_API_CONTRACTS: Tuple[ApiContractEntry, ...] = (
    ApiContractEntry('GET', '/emlis/threads/by-input/{emotion_id}', 'emlis.thread.read.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Q4 mode-gated reader; authenticated owner, persisted snapshots, no generation; additive can_write'),
    ApiContractEntry('POST', '/emlis/threads/{thread_id}/answers', 'emlis.thread.answer.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Q4 admitted writes only; one answer per issued question, meaning before body'),
    ApiContractEntry('POST', '/emlis/threads/{thread_id}/actions', 'emlis.thread.action.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Q4 admitted writes only; skip/stop or confirmed transient failure retry; Q3 explicit continuation within server budget'),
    ApiContractEntry('POST', '/emlis/threads/{thread_id}/frames', 'emlis.thread.frame_feedback.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Q4 admitted writes only; owned tentative frame confirmation, rejection or correction; no question budget'),
    ...
    ApiContractEntry('POST', '/ops/client-events', 'ops.client_events.write.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Best-effort RN client observability event ingest; no product state mutation'),
    ...
    ApiContractEntry('GET', '/account/profile-create', 'account.profile_create.read.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Account screen ProfileCreate summary surface'),
    ...
    ApiContractEntry('GET', '/emotion-log/feed', 'emotion_log.feed.read.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current EmotionLog feed replacement for legacy /friends/feed'),
    ApiContractEntry('GET', '/emotion-log/unread-status', 'emotion_log.unread.status.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current EmotionLog unread replacement for legacy /friends/unread-status'),
    ApiContractEntry('POST', '/emotion-log/unread/read-feed', 'emotion_log.unread.read_feed.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current EmotionLog feed read marker'),
    ...
    ApiContractEntry('GET', '/today-question/current', 'today_question.current.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='May return additive personal_followup fields: question_origin, personal_question_id, question_type, source_anchor and optional_free_text_enabled'),
    ...
    ApiContractEntry('POST', '/today-question/answers', 'today_question.answers.create.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Accepts additive personal_followup guard fields while static role-probe payload remains compatible'),
    ApiContractEntry('GET', '/today-question/history', 'today_question.history.list.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='May include self-only personal_followup metadata and source_anchor_summary'),
    ...
    ApiContractEntry('POST', '/friends/request', 'friends.request.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/follow/request'),
    ApiContractEntry('POST', '/friends/requests/{request_id}/accept', 'friends.requests.accept.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/follow/requests/{request_id}/accept'),
    ApiContractEntry('POST', '/friends/requests/{request_id}/reject', 'friends.requests.reject.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/follow/requests/{request_id}/reject'),
    ApiContractEntry('POST', '/friends/requests/{request_id}/cancel', 'friends.requests.cancel.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/follow/requests/{request_id}/cancel'),
    ApiContractEntry('POST', '/friends/remove', 'friends.remove.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/follow/remove'),
    ApiContractEntry('GET', '/friends/notification-settings', 'friends.notification_settings.read.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/emotion-notifications/settings'),
    ApiContractEntry('POST', '/friends/notification-settings/{friend_user_id}', 'friends.notification_settings.update.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/emotion-notifications/settings/{friend_user_id}'),
    ApiContractEntry('GET', '/emotion-notifications/settings', 'emotion_notifications.settings.read.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current EmotionNotification settings read surface'),
    ApiContractEntry('POST', '/emotion-notifications/settings/{friend_user_id}', 'emotion_notifications.settings.update.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Current EmotionNotification settings update surface'),
    ...
    ApiContractEntry('GET', '/mymodel/qna/echoes/reflections', 'mymodel.qna.echoes.reflections.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/resonances/pieces'),
    ApiContractEntry('GET', '/mymodel/qna/list', 'mymodel.qna.list.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/library'),
    ApiContractEntry('GET', '/mymodel/qna/unread', 'mymodel.qna.unread.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/unread'),
    ApiContractEntry('GET', '/mymodel/qna/unread-status', 'mymodel.qna.unread_status.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/unread-status', notes='MyModel Home reflections unread aggregated across self + followed owners'),
    ApiContractEntry('POST', '/mymodel/qna/view', 'mymodel.qna.view.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/view'),
    ApiContractEntry('POST', '/mymodel/qna/resonance', 'mymodel.qna.resonance.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/resonance'),
    ApiContractEntry('POST', '/mymodel/qna/echoes/submit', 'mymodel.qna.echoes.submit.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/resonances/submit'),
    ApiContractEntry('POST', '/mymodel/qna/echoes/delete', 'mymodel.qna.echoes.delete.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/piece/resonances/delete'),
    ...
    ApiContractEntry('POST', '/analysis/reports/ensure', 'analysis.reports.ensure.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Analysis core reportValidity meta is additive under content_json.reportValidity; no diagnosis or overclaim output'),
    ApiContractEntry('GET', '/analysis/reports/ready', 'analysis.reports.ready.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Read-side contract may include additive content_json.reportValidity meta'),
    ApiContractEntry('GET', '/analysis/reports/{report_id}', 'analysis.reports.detail.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Detail may include additive content_json.reportValidity meta'),
    ...
    ApiContractEntry('GET', '/self-structure/latest', 'self_structure.latest.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Latest self-structure meta may include additive reportValidity and content_json.watashiMap'),
    ApiContractEntry('POST', '/self-structure/monthly/ensure', 'self_structure.monthly.ensure.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Self-structure reports attach additive content_json.reportValidity and content_json.watashiMap meta'),
    ...
    ApiContractEntry('GET', '/self-structure/reports/{report_id}', 'self_structure.reports.detail.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Detail meta may include additive reportValidity and content_json.watashiMap'),
    ...
    ApiContractEntry('POST', '/emotion/piece/preview', 'emotion.piece.preview.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Emotion input -> Piece preview; piece_text is the current display answer while reflection_text remains compat; visibility/generation/transform/safety metadata is additive'),
    ApiContractEntry('POST', '/emotion/piece/publish', 'emotion.piece.publish.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Publishes an existing preview draft by status transition only; publish must not regenerate or alter piece_text'),
    ...
    ApiContractEntry('DELETE', '/nexus/pieces/{q_instance_id}', 'nexus.pieces.delete.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Deletes only the viewer-owned Piece and related per-instance read/reaction state'),
    ...
    ApiContractEntry('GET', '/nexus/emotion-log', 'nexus.emotion_log.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Nexus Home-side EmotionLog preview proxy'),
    ApiContractEntry('GET', '/nexus/emotion-ranking', 'nexus.emotion_ranking.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, notes='Nexus Home-side emotion ranking preview proxy'),
