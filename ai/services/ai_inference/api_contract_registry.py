...
PUBLIC_API_CONTRACTS: Tuple[ApiContractEntry, ...] = (
    ...
    ApiContractEntry('GET', '/mymodel/qna/holders', 'mymodel.qna.holders.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/nexus/reflections', notes='Deprecated compatibility route; returns disabled/empty payloads after ProfileCreate discovery retirement'),
    ...
    ApiContractEntry('GET', '/mymodel/qna/trending', 'mymodel.qna.trending.v1', OWNER_PUBLIC_API, REQUEST_POLICY_ADDITIVE_ONLY, RESPONSE_POLICY_ADDITIVE_ONLY, deprecated=True, replacement='/nexus/reflections', notes='Deprecated compatibility route; returns disabled/empty payloads after ProfileCreate discovery retirement'),
