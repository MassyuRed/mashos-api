    ...
    return {
        ...
        "console_targets": {
            "apple": {
                ...
                "intro_offer_expectation": "Plus should have a 1-month introductory free trial in the same subscription group as future upgrade paths.",
            ...
            "google": {
                ...
                "offer_expectation": "Plus should have at least one active base plan and, when launched, a 1-month free-trial offer tagged for new users.",
