# -*- coding: utf-8 -*-
"""Legacy piece generated reflection access compat facade.

Runtime body now lives in ``piece_generated_access``. This file is intentionally
...
import piece_generated_access as _current
