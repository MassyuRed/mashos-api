...
"""Forward-only rc0023 natural surface successor.
...
STEP11_SURFACE_REALIZATION_PLAN_SCHEMA = (
    "cocolon.emlis.nls_v3.step11_surface_realization_plan.rc0023.v1"
)
...
def _derive_surface_realization_plan(
    ...
    """Recompute the committed rc0023 plan from semantic ownership only."""
