# -*- coding: utf-8 -*-
"""Legacy astor reflection store compat facade.

Runtime body now lives in ``piece_generation_store``. This file is intentionally
...
import piece_generation_store as _current
