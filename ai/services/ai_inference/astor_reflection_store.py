...
QNA_METRICS_TABLE = (os.getenv("COCOLON_MYMODEL_QNA_METRICS_TABLE") or "mymodel_qna_metrics").strip() or "mymodel_qna_metrics"
...
async def fetch_staged_generated_reflections(*, user_id: str, source_hash: Optional[str] = None) -> List[Dict[str, Any]]:
    ...
    return await _sb_get_json(f"/rest/v1/{REFLECTIONS_TABLE}", params=params, timeout=10.0)
