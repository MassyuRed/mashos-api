...
_BODY_RECEPTION_MARKERS: Final[tuple[tuple[str, re.Pattern[str]], ...]] = (
    ...
    ("receive", re.compile(r"受け止め|大切に思|大切にした|大切にしたい|尊重|のですね|のです|のだと受け取りました|一緒に見ていきたいです|として読めます|として受け取れます")),
    ...
    *,
    ...
    return _dedupe(
        (
            ...
            *_reception_contract_atoms(reception_plan, recovery_stage, plan=plan, resolver=resolver,),
            *(
            ...
            _make_line(
                ...
                extra_atoms=(
                    *_human_follow_atoms(
                        ...
                        reception_plan,
                        recovery_stage,
                        target_already_delivered=target_already_delivered, plan=plan, resolver=resolver,
                    ),
    ...
    if plan.coverage_requirements.human_follow_required:
        ...
        if len(reception_lines) != 1:
            ...
            expected_clause_plans = (
                build_grounded_reception_clause_plans(
                    reception_plan,
                    sentence_plan.recovery_stage, plan=plan, resolver=resolver,
                )
