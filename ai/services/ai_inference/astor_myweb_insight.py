# -*- coding: utf-8 -*-
"""Legacy astor myweb insight compat facade.

Runtime body now lives in ``astor_analysis_insight``. This file is intentionally
...
import astor_analysis_insight as _current
