...
- 出力は analysis_report_schema.json（wire version: myweb.report.v1）に準拠する。
...
def generate_myweb_insight_report(user_id: str, period_days: int = 30, lang: str = "ja") -> Dict[str, Any]:
    ...
    # analysis_report_schema.json は additionalProperties=false なので、
    # 余計なキーを足さないこと（ここで固定）。
    return report
