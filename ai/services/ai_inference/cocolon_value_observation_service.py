...
def _signal(
    *,
    ...
    return ValueObservationSignal(
        ...
        # Phase 1 seal: value_observation may keep structured signals for
        # Piece / Analysis, but it must not carry ready-to-display Emlis
        # observation sentences into the EmlisAI body path.
        emlis_text="",
