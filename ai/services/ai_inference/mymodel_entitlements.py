# -*- coding: utf-8 -*-
"""Legacy mymodel entitlements compat facade.

Runtime body now lives in ``profile_create_entitlements``. This file is intentionally
...
import profile_create_entitlements as _current
