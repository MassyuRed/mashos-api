# -*- coding: utf-8 -*-
"""Legacy emotion reflection store compat facade.

Runtime body now lives in ``emotion_piece_store``. This file is intentionally
...
import emotion_piece_store as _current
