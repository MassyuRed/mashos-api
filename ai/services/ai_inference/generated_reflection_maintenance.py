# -*- coding: utf-8 -*-
"""Legacy generated reflection maintenance compat facade.

Runtime body now lives in ``piece_generated_maintenance``. This file is intentionally
...
import piece_generated_maintenance as _current
