# -*- coding: utf-8 -*-
"""Legacy myprofile section text templates compat facade.

Runtime body now lives in ``self_structure_section_text_templates``. This file is intentionally
...
import self_structure_section_text_templates as _current
