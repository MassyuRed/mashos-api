...
def build_user_label_connection_p5_product_quality_review(
    *,
    ...
    summary = {
        ...
        "human_qa_completed": p5_limited_visible_allowed,
        "human_qa_status": "confirmed" if p5_limited_visible_allowed else "not_confirmed",
        "human_qa_hold_id": "" if p5_limited_visible_allowed else "P5-HOLD-001",
        "human_qa_unfinished": not p5_limited_visible_allowed,
        "product_quality_confirmed": p5_limited_visible_allowed,
        "runtime_connection_is_product_quality_confirmation": False,
...
def user_label_connection_p5_product_quality_review_public_summary(value: Mapping[str, Any] | None) -> dict[str, Any]:
    ...
    summary = {
        ...
        "human_qa_required": True,
        "human_qa_completed": meta.get("human_qa_completed") is True,
        "human_qa_status": _clean(meta.get("human_qa_status")) or ("confirmed" if meta.get("human_qa_completed") is True else "not_confirmed"),
        "human_qa_hold_id": "" if meta.get("human_qa_completed") is True else "P5-HOLD-001",
        "product_quality_confirmed": meta.get("product_quality_confirmed") is True,
