# -*- coding: utf-8 -*-
"""Legacy reflection text formatter compat facade.

Runtime body now lives in ``piece_text_formatter``. This file is intentionally
...
import piece_text_formatter as _current
